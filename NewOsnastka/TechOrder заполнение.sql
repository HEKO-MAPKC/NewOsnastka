...
--proos
insert into Osnastka.TechOrder (IsApplicationFrom,DraftID, FactoryOrder, FactoryNumberOrder,WorkshopID,NameDraftProduct,TechOrd,TypeOsnast,ReasonProduction,DateLimitation,AuthorTechnolog,DateCreateApplication,
...
SELECT 1 as IsApplicationFrom
  ...
  left join DraftInfoFull f1 on 
	cast(p.[draft] as numeric (13,2)) = f1.draft
